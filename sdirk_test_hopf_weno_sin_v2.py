        ...
        for CFL in CFL_arr:
            ...
            for y, yi, o in zip(y_orders, yi_orders, orders):
                ...
                if o == 1:
                    ...
                    f = open('{eq},{exact}_v2,t={tf},IM={im}.txt'.format(eq=equation, exact=exact_solution_type, tf=t1,
                                                                      im=implicit_method), 'a')
                    g = open(
                        '{eq},{exact}_v2,t={tf},IM={im}-time.txt'.format(eq=equation, exact=exact_solution_type, tf=t1,
                                                                      im=implicit_method),
                        'a')
            ...
            plt.savefig('{eq},{exact}_v2,t={tf},IM={im},CFL={cfl}.png'.format(eq=equation, exact=exact_solution_type, tf=t1,
